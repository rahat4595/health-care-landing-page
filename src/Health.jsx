...
const Health = () => {
    return (
        <section className="bg-[#ffc6370c] h-full md:h-[928px] rounded-2xl p-5">
            <div className="my-20 grid grid-cols-1 md:grid-cols-2 mt-5 ml-5">
                <div className="mt-5">
                    <span className=" rounded-full border-[0.5px] border-[#020043] px-5 py-2 font-medium text-[#020043]">Services</span>
                    <h2 className="font-semibold text-4xl text-[#020043] md:pr-48 mt-8">
